class Capabilities {
  ...
  const Capabilities._values(this.startTls, this.smtpUtf8, this.authPlain, this.authLogin, this.all);


  factory Capabilities.fromResponse(Iterable<String> ehloMessage) {
    final List<String> capabilities = new List.unmodifiable(ehloMessage.map((m) => m.toUpperCase()));
